...
segment .data
	...
	outputPrompt:	db "Welcome to Smiths Seed Inventory Control System", 10, 0
	outputPrompt2:	db "Please have product number, product name, price, cost, and quantity information ready.", 10, 0
	...
	outputTotalQuantity:	db "Total Inventory Quantity:    %d", 10, 0
	outputTotalValue:	db "Total Inventory Assets:    $%.2lf", 10, 0
	outputTotalCost:	db "Total Inventory Liability: $%.2lf", 10, 0
...
asm_main:
	...
	mov	rdi, outputPrompt
	call	printf
	mov	rdi, outputPrompt2
	call	printf

	add	rsp, 8	;fix stack alignment
