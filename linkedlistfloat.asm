...
segment .data
	...
	outputNA:  db "Product Name: %s",10,0
   	outputPR:  db "Product Price: %1s%-10.2lf",10,0	; .2 = rounded to 2 decimal places
	outputCO:  db "Product Cost: %2s%-11.2lf",10,0
	outputQU:  db "Product Quantity: %d",10,0

	dollarSign: db "$",0		; I love extra credit !!!! Go C!!!

	totalLiabOut: db "Total Inventory Liability: %1s%-10.2lf",10,0
	totalAssetOut: db "Total Inventory Assets: %4s%-13.2lf",10,0
